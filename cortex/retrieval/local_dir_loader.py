...
from cortex.retrieval.loader import BaseDataLoader
from cortex.types import DataIngestionMode, DataPoint,  LoadedDataPoint
...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_filename = os.path.join(log_dir, f"load_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
